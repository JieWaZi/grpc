...
func request_FirstCalculationService_AddCalculation_0(ctx context.Context, marshaler runtime.Marshaler, client FirstCalculationServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq AddCalculationRequest
	...
	msg, err := client.AddCalculation(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
...
var (
	pattern_FirstCalculationService_AddCalculation_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"calculation", "add"}, ""))
)

var (
	forward_FirstCalculationService_AddCalculation_0 = runtime.ForwardResponseMessage
)
